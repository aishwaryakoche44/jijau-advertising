...
const Home = () => {
  ...
  return (
    ...
    {/* ================= HERO ================= */}
<section className="w-full px-6 md:px-10 lg:px-16 pt-20 md:pt-28 pb-8 md:pb-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-10 lg:gap-16 relative">
  ...
  >
    <div className="relative overflow-hidden">
      <img
        ...
        className="w-full max-h-[560px] sm:max-h-[620px] md:max-h-[720px] object-contain rounded-[48px] sm:rounded-[64px] block"
      />
    </div>
  </motion.div>
    ...
    {/* ================= TRUST ================= */}
<section className="py-10 md:py-12 border-y border-white/5 bg-[#050505] relative overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-6 relative z-10">
    ...
    >
      <p className="text-[#fcab0f] font-bold uppercase tracking-[0.3em] text-xs mb-3">
        Industry Expertise
      </p>
    ...
    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
      {[
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="group p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-[#fcab0f]/50 hover:bg-white/[0.07] transition-all duration-500 text-center"
        >
          <item.icon className="w-8 h-8 mx-auto mb-3 text-gray-500 group-hover:text-[#fcab0f] group-hover:scale-110 transition-all duration-500" />
     ...
     {/* ================= SERVICES ================= */}
<section className="py-10 md:py-12 px-5 sm:px-6 md:px-10">
  <div className="max-w-7xl mx-auto">
    <h2 className="text-4xl sm:text-5xl md:text-6xl font-black mb-8 md:mb-10 leading-tight text-left">
    ...
    {/* ================= WHY US ================= */}
<motion.section
  className="py-10 md:py-12 bg-[#0a0a0a] px-6"
  initial="hidden"
  whileInView="visible"
  viewport={{ once: true }}
  variants={fadeUp}
...
<section className="py-10 md:py-12 bg-black overflow-hidden">
